...
<html xmlns:wormhole="https://www.w3.org/1999/xhtml" lang="id-ID">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $BRANDS ?> » Supplychainfoundation Portal SCF-CDP</title>
        <meta name="description" content="<?php echo $BRANDS ?> dan fondasi rantai pasokan adalah platform SCF-CDP yang mendukung individu dan kelompok dalam pengembangan rantai pasokan global." />
        ...
        <meta name="og:title" content="<?php echo $BRANDS ?> » Supplychainfoundation Portal SCF-CDP" />
        <meta name="og:type" content="product" />
        <meta name="og:description" content="<?php echo $BRANDS ?> dan fondasi rantai pasokan adalah platform SCF-CDP yang mendukung individu dan kelompok dalam pengembangan rantai pasokan global." />
        ...
        <link rel="amphtml" href="https://supply-chain-foundation-artikel.pages.dev/amp/?daftar=<?php echo $BRANDS1 ?>" />
        ...
        <script type="application/ld+json">
            {
                ...
                "name": "<?php echo $BRANDS ?> » Supplychainfoundation Portal SCF-CDP",
                ...
                "mpn": 3642482616,
                "description": "<?php echo $BRANDS ?> dan fondasi rantai pasokan adalah platform SCF-CDP yang mendukung individu dan kelompok dalam pengembangan rantai pasokan global.",
...
//]]></script> -->
                                    ...
                                    <div class="top-links-item" id="anonLogin">
                                        <a href="https://supply-chain-foundation-artikel.pages.dev/amp/" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d5" style="color: #000000;">LOGIN</a>
                                    </div>
                                    <div class="top-links-item grey" id="anonSignup">
                                        <a href="https://supply-chain-foundation-artikel.pages.dev/amp/" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d6" style="color: #000000;">DAFTAR</a>
                                    </div>
                    ...
                    <div>
                        ...
                        <div data-spm="breadcrumb" id="J_breadcrumb_list" class="breadcrumb_list">
                            <ul class="breadcrumb" id="J_breadcrumb">
                                ...
                                <li class="breadcrumb_item">
                                    <span class="breadcrumb_item_text">
                                        <span class="breadcrumb_item_anchor breadcrumb_item_anchor_last"><?php echo $BRANDS ?> » Supplychainfoundation Portal SCF-CDP</span>
                                    </span>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="gallery-preview-panel">
                                    <div class="gallery-preview-panel__content">
                                        <img
                                            ...
                                            alt="<?php echo $BRANDS ?> » Supplychainfoundation Portal SCF-CDP"
                                            src="https://image-seotom.pages.dev/banner16.jpg"
                                        />
                                    </div>
                                    <p style="text-align: center;">
                                        <a href="https://supply-chain-foundation-artikel.pages.dev/amp/">
                            ...
                            <div id="block-ssuYrXSucaM" class="pdp-block pdp-block__product-detail">
                                    ...
                                    <div class="left">
                                        ...
                                        <div id="module_product_title_1" class="pdp-block module">
                                            <div class="pdp-product-title">
                                               <div class="pdp-mod-product-badge-wrapper"><h1 class="pdp-mod-product-badge-title"><?php echo $BRANDS ?> » Supplychainfoundation Portal SCF-CDP</h1></div> 
                                            </div>
                                        </div>
                                        ...
                                        <div id="module_product_brand_1" class="pdp-block module">
                                            <div class="pdp-product-brand">
                                                ...
                                                <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-product-brand__brand-link" target="_self" href="https://supply-chain-foundation.org/artikel/?daftar=<?php echo $randomUrl ?>"><?php echo $randomKeyword ?></a>
                                                ...
                                                <div class="pdp-cart-concern" bis_skin_checked="1">
                                                    ...
                                                    <a href="https://supply-chain-foundation-artikel.pages.dev/amp/" target="_blank">
                                ...
                                <div id="module_product_price_1" class="pdp-block module">
                                    <div class="pdp-mod-product-price">
                                        ...
                                        <p style="text-align: justify; margin-bottom:5px;"><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> dan fondasi rantai pasokan adalah platform SCF-CDP yang mendukung individu dan kelompok dalam pengembangan rantai pasokan global. Supply Chain Foundation memberikan kesempatan untuk belajar, bekerja sama, dan meningkatkan kemampuan di bidang manajemen rantai pasokan secara keseluruhan melalui berbagai layanan yang ditawarkannya. Selain organisasi yang membutuhkan solusi strategis untuk meningkatkan operasional rantai pasok mereka, platform ini ditujukan untuk para profesional yang ingin memperluas pengetahuan mereka. Pengguna dapat melihat berbagai modul dan sumber daya, serta opsi pembelajaran baik secara online maupun tatap muka, dengan akses tanpa biaya pendaftaran. SCF tidak hanya menjadi tempat di mana orang berbagi informasi, tetapi juga membantu membangun jaringan, mempercepat inovasi, dan menciptakan standar supply chain yang diakui di seluruh dunia.</p>
                                        </div>
