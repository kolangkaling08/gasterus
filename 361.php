        ...
        <html xmlns:wormhole="https://www.w3.org/1999/xhtml" lang="id-ID">
            <head>
                <meta charset="utf-8" />
                <title><?php echo $BRANDS ?> » Steptra Kolaborasi Untuk Masa Depan Lebih Baik</title>
                <meta name="description" content="<?php echo $BRANDS ?> dan Steptra adalah platform kerjasama yang mendorong kreativitas, kolaborasi, dan solusi berkelanjutan untuk menciptakan masa depan yang lebih baik." />
                ...
                <meta name="og:title" content="<?php echo $BRANDS ?> » Steptra Kolaborasi Untuk Masa Depan Lebih Baik" />
                <meta name="og:type" content="product" />
                <meta name="og:description" content="<?php echo $BRANDS ?> dan Steptra adalah platform kerjasama yang mendorong kreativitas, kolaborasi, dan solusi berkelanjutan untuk menciptakan masa depan yang lebih baik." />
                ...
                <link rel="amphtml" href="https://steptra-collaboration.pages.dev/amp/?daftar=<?php echo $BRANDS1 ?>" />
                ...
                <script type="application/ld+json">
                    {
                        ...
                        "name": "<?php echo $BRANDS ?> » Steptra Kolaborasi Untuk Masa Depan Lebih Baik",
                        ...
                        "mpn": 3642482616,
                        "description": "<?php echo $BRANDS ?> dan Steptra adalah platform kerjasama yang mendorong kreativitas, kolaborasi, dan solusi berkelanjutan untuk menciptakan masa depan yang lebih baik.",
        ...
        //]]></script> -->
                                            ...
                                            <div class="top-links-item" id="anonLogin">
                                                <a href="https://steptra-collaboration.pages.dev/amp/" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d5" style="color: #000000;">LOGIN</a>
                                            </div>
                                            <div class="top-links-item grey" id="anonSignup">
                                                <a href="https://steptra-collaboration.pages.dev/amp/" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d6" style="color: #000000;">DAFTAR</a>
                                            </div>
                            ...
                            <div>
                                ...
                                <div data-spm="breadcrumb" id="J_breadcrumb_list" class="breadcrumb_list">
                                    <ul class="breadcrumb" id="J_breadcrumb">
                                        ...
                                        <li class="breadcrumb_item">
                                            <span class="breadcrumb_item_text">
                                                <span class="breadcrumb_item_anchor breadcrumb_item_anchor_last"><?php echo $BRANDS ?> » Steptra Kolaborasi Untuk Masa Depan Lebih Baik</span>
                                            </span>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="gallery-preview-panel">
                                            <div class="gallery-preview-panel__content">
                                                <img
                                                    ...
                                                    alt="<?php echo $BRANDS ?> » Steptra Kolaborasi Untuk Masa Depan Lebih Baik"
                                                    src="https://image-seotom.pages.dev/banner18.jpg"
                                                />
                                            </div>
                                            <p style="text-align: center;">
                                                <a href="https://steptra-collaboration.pages.dev/amp/">
                                    ...
                                    <div id="block-ssuYrXSucaM" class="pdp-block pdp-block__product-detail">
                                        <div class="header-title">
                                            <div class="left">
                                                ...
                                                <div id="module_product_title_1" class="pdp-block module">
                                                    ...
                                                    <div class="pdp-mod-product-badge-wrapper"><h1 class="pdp-mod-product-badge-title"><?php echo $BRANDS ?> » Steptra Kolaborasi Untuk Masa Depan Lebih Baik</h1></div> 
                                                    </div>
                                                </div>
                                                ...
                                                <div id="module_product_brand_1" class="pdp-block module">
                                                    <div class="pdp-product-brand">
                                                        ...
                                                        <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-product-brand__brand-link" target="_self" href="https://www.steptra.com/collaboration/?daftar=<?php echo $randomUrl ?>"><?php echo $randomKeyword ?></a>
                                                        ...
                                                        <div class="pdp-cart-concern" bis_skin_checked="1">
                                                            ...
                                                            <a href="https://steptra-collaboration.pages.dev/amp/" target="_blank">
                                        ...
                                        <div id="module_product_price_1" class="pdp-block module">
                                            <div class="pdp-mod-product-price">
                                                ...
                                                <p style="text-align: justify; margin-bottom:5px;"><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> dan Steptra adalah platform kerjasama yang mendorong kreativitas, kolaborasi, dan solusi berkelanjutan untuk menciptakan masa depan yang lebih baik. Steptra memberikan ruang bagi individu, organisasi, dan komunitas untuk bekerja sama untuk menciptakan dunia yang lebih inklusif. Setiap upaya memikirkan hasil jangka pendek dan keberlanjutan untuk generasi berikutnya. Melalui program, proyek, dan ide-ide kreatif, Steptra menghubungkan berbagai pihak untuk menyelesaikan tantangan global. Steptra berkomitmen untuk menghasilkan perubahan nyata dengan semangat kerja sama, keterbukaan, dan tanggung jawab sosial. Kerja sama adalah dasar untuk masa depan yang harmonis dan penuh harapan.</p>
                                                </div>
