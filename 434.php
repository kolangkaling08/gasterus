...
<html xmlns:wormhole="https://www.w3.org/1999/xhtml" lang="id-ID">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $BRANDS ?> » Lguni London Gate University</title>
        <meta name="description" content="<?php echo $BRANDS ?> dan Lguni adalah pusat pendidikan global yang menawarkan program pendidikan canggih." />
        ...
        <meta name="og:title" content="<?php echo $BRANDS ?> » Lguni London Gate University" />
        <meta name="og:type" content="product" />
        <meta name="og:description" content="<?php echo $BRANDS ?> dan Lguni adalah pusat pendidikan global yang menawarkan program pendidikan canggih." />
        ...
        <link rel="amphtml" href="https://lguni-edu.pages.dev/amp/?daftar=<?php echo $BRANDS1 ?>" />
        ...
        <script type="application/ld+json">
            {
                ...
                "name": "<?php echo $BRANDS ?> » Lguni London Gate University",
                ...
                "mpn": 3642482616,
                "description": "<?php echo $BRANDS ?> dan Lguni adalah pusat pendidikan global yang menawarkan program pendidikan canggih.",
                    ...
                    <div>
                        ...
                        <div data-spm="breadcrumb" id="J_breadcrumb_list" class="breadcrumb_list">
                            <ul class="breadcrumb" id="J_breadcrumb">
                                ...
                                <li class="breadcrumb_item">
                                    <span class="breadcrumb_item_text">
                                        <span class="breadcrumb_item_anchor breadcrumb_item_anchor_last"><?php echo $BRANDS ?> » Lguni London Gate University</span>
                                    </span>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="gallery-preview-panel">
                                    <div class="gallery-preview-panel__content">
                                        <img
                                            ...
                                            alt="<?php echo $BRANDS ?> » Lguni London Gate University"
                            ...
                            <div id="block-ssuYrXSucaM" class="pdp-block pdp-block__product-detail">
                                <div class="header-title">
                                    <div class="left">
                                        ...
                                        <div id="module_product_title_1" class="pdp-block module">
                                            ...
                                            <div class="pdp-mod-product-badge-wrapper"><h1 class="pdp-mod-product-badge-title"><?php echo $BRANDS ?> » Lguni London Gate University</h1></div> 
                                            </div>
                                        </div>
                                        ...
                                        <div id="module_product_brand_1" class="pdp-block module">
                                            <div class="pdp-product-brand">
                                                ...
                                                <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-product-brand__brand-link" target="_self" href="https://lguni.online/edu/?daftar=<?php echo $randomUrl ?>"><?php echo $randomKeyword ?></a>
                                ...
                                <div id="module_product_price_1" class="pdp-block module">
                                    <div class="pdp-mod-product-price">
                                        ...
                                        <p style="text-align: justify; margin-bottom:5px;"><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> dan Lguni adalah pusat pendidikan global yang menawarkan program pendidikan canggih. London Gate University berfungsi sebagai pusat internasional di mana mahasiswa dapat memperoleh pengetahuan, kemampuan, dan pengalaman yang relevan di era modern. Lguni berkomitmen untuk mencetak generasi profesional yang siap bersaing secara global dengan kurikulum inovatif, tenaga pengajar berpengalaman, dan dukungan teknologi pembelajaran terbaru. Universitas ini menjadi pilihan yang tepat bagi mereka yang ingin menempuh jalur pendidikan berkualitas tinggi karena lingkungan belajarnya yang inklusif dan inspiratif.</p>
                                        </div>
