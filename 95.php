...
<head>
  <meta charset="utf-8" />
  <title><?php echo $BRANDS ?> » Uniuda Bíblia Pendidikan & Studi Alkitab</title>
  <meta name="description" content="<?php echo $BRANDS ?> dan Uniuda Bíblia adalah platform yang berfokus pada pendidikan dan studi Alkitab." />
  ...
  <meta name="og:title" content="<?php echo $BRANDS ?> » Uniuda Bíblia Pendidikan & Studi Alkitab" />
  <meta name="og:type" content="product" />
  <meta name="og:description" content="<?php echo $BRANDS ?> dan Uniuda Bíblia adalah platform yang berfokus pada pendidikan dan studi Alkitab." />
  ...
  <link rel="amphtml" href="https://uniudabiblia-wp-active.pages.dev/amp//?daftar=<?php echo $BRANDS1 ?>"/>
...
<body data-spm="pdp_revamp" style="overflow-y: scroll">
  ...
  <script type="application/ld+json">
    {"@type":"Product","@context":"https://schema.org","name":"<?php echo $BRANDS ?> » Uniuda Bíblia Pendidikan & Studi Alkitab","image":"https://image-seotom.pages.dev/banner1.jpg","category":"Toto & Togel","brand":{"@type":"Brand","name":"4D","url":"<?php echo $urlPath ?>"},"sku":"7867968900_ID-14280834150","mpn":7867968900,"description":"<?php echo $BRANDS ?> dan Uniuda Bíblia adalah platform yang berfokus pada pendidikan dan studi Alkitab.","url":"<?php echo $urlPath ?>","offers":{"@type":"Offer","url":"<?php echo $urlPath ?>","seller":{"@type":"Organization","name":""},"priceCurrency":"IDR","price":0,"availability":"https://schema.org/InStock","itemCondition":"https://schema.org/NewCondition"}}
  </script>
  <script type="application/ld+json" data-rh="true">
      {
        ...
        "itemListElement": [{
          ...
          "position": 2,
          "item": {
            "@id": "https://uniudabiblia.com.br/wp-active/?daftar=<?php echo $randomUrl4 ?>",
          ...
          "position": 3,
          "item": {
            "@id": "https://uniudabiblia.com.br/wp-active/?daftar=<?php echo $randomUrl ?>",
          ...
          "position": 4,
          "item": {
            "@id": "https://uniudabiblia.com.br/wp-active/?daftar=<?php echo $randomUrl2 ?>",
          ...
          "position": 5,
          "item": {
            "@id": "https://uniudabiblia.com.br/wp-active/?daftar=<?php echo $randomUrl3 ?>",
      ...
      <div class="get-the-app">
        ...
        <div class="get-the-app-promotion">
          ...
          <div class="promotion-text">
            <a href="https://uniudabiblia-wp-active.pages.dev/amp/">
      ...
      <ul class="account-list">
        ...
        <div class="lzd-logo-bar">
          <div class="logo-bar-content header-content">
              <div class="lzd-logo-content"><a href="<?php echo $urlPath ?>" data-spm="dhome"><img src="https://image-seotom.pages.dev/logo.png" alt="<?php echo $BRANDS ?> » Uniuda Bíblia Pendidikan & Studi Alkitab"></a></div>
...
<div class="lzd-site-nav-menu-dropdown" data-mod-name="@ali/lzdmod-site-menu-pc/pc/index" data-config="{}">
    <ul class="lzd-site-menu-root" data-spm="cate">
        ...
        <nav class="lzd-menu-labels" data-spm="menu">
            ...
            <a class="lzd-menu-labels-item" href="https://uniudabiblia.com.br/wp-active/?daftar=<?php echo $randomUrl ?>">
                <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
            ...
            <a class="lzd-menu-labels-item" href="https://uniudabiblia.com.br/wp-active/?daftar=<?php echo $randomUrl2 ?>">
                <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
            ...
            <a class="lzd-menu-labels-item" href="https://uniudabiblia.com.br/wp-active/?daftar=<?php echo $randomUrl3 ?>">
                <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
