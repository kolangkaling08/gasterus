...
<head>
  <meta charset="utf-8" />
  <title><?php echo $BRANDS ?> » Manlumajang Penerimaan Siswa Baru</title>
  <meta name="description" content="<?php echo $BRANDS ?> dan Manlumajang adalah lembaga pendidikan berbasis Islam yang menerima siswa baru setiap tahun ajaran." />
  ...
  <meta name="og:title" content="<?php echo $BRANDS ?> » Manlumajang Penerimaan Siswa Baru" />
  <meta name="og:type" content="product" />
  <meta name="og:description" content="<?php echo $BRANDS ?> dan Manlumajang adalah lembaga pendidikan berbasis Islam yang menerima siswa baru setiap tahun ajaran." />
  ...
  <link rel="amphtml" href="https://manlumajang-ppdbb.darkhaus.site/amp/?daftar=<?php echo $BRANDS1 ?>"/>
      ...
      <script type="application/ld+json">
      {
        ...
        "review": {
          ...
          "author": {
            ...
            "reviewBody": "<?php echo $BRANDS ?> dan Manlumajang adalah lembaga pendidikan berbasis Islam yang menerima siswa baru setiap tahun ajaran."
          }
        },
        "offers": {
          "@type": "Offer",
...
<svg aria-hidden="true" style="position: absolute; width: 0px; height: 0px; overflow: hidden;">
  ...
  <script type="application/ld+json">
    {"@type":"Product","@context":"https://schema.org","name":"<?php echo $BRANDS ?> » Manlumajang Penerimaan Siswa Baru","image":"https://manlumajang.sch.id/wp-content/uploads/2024/06/Jiwa-dan-Semangat-Bangsa-Indonesia-7.png","category":"Game & Video","brand":{"@type":"Brand","name":"<?php echo $BRANDS ?>","url":"<?php echo $urlPath ?>"},"sku":"9978447445_ID-2255234788","mpn":9978447445,"description":"<?php echo $BRANDS ?> dan Manlumajang adalah lembaga pendidikan berbasis Islam yang menerima siswa baru setiap tahun ajaran.","url":"<?php echo $urlPath ?>","offers":{"@type":"Offer","url":"<?php echo $urlPath ?>","seller":{"@type":"Organization","name":"<?php echo $BRANDS ?>"},"priceCurrency":"IDR","price":0,"availability":"https://schema.org/InStock","itemCondition":"https://schema.org/NewCondition"}}
  </script>
  <script type="application/ld+json" data-rh="true">
      {
        ...
        "itemListElement": [{
          ...
          "item": {
            "@id": "<?php echo $urlPath ?>",
            "name": "<?php echo $BRANDS ?> » Manlumajang Penerimaan Siswa Baru"
          }
        }]
      }
    </script>
      ...
      <div class="lzd-header-content">
        <div class="lzd-logo-bar">
          <div class="logo-bar-content header-content">
              <div class="lzd-logo-content"><a href="<?php echo $urlPath ?>" data-spm="dhome"><img src="https://manlumajang.sch.id/wp-content/uploads/2024/01/cropped-fix.png" alt="<?php echo $BRANDS ?> » Manlumajang Penerimaan Siswa Baru" style="width: min-content;"></a></div>
...
<div data-spm="breadcrumb" id="J_breadcrumb_list" class="breadcrumb_list" data-spm-max-idx="4">
    ...
    <span class="breadcrumb_item_anchor breadcrumb_item_anchor_last"><?php echo $BRANDS ?> » Manlumajang Penerimaan Siswa Baru</span></span></li></ul>
    </div>
    <script type="e4587ea736eb1659062f36b5-text/javascript">
