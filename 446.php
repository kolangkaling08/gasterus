...
<html xmlns:wormhole="https://www.w3.org/1999/xhtml" lang="id-ID">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $BRANDS ?> » Fm200 Sistem Pemadam Api Otomatis</title>
        <meta name="description" content="<?php echo $BRANDS ?> dan Fm200 adalah sistem pemadam api otomatis yang ramah lingkungan dan memiliki daya padam cepat tanpa sisa." />
        ...
        <meta name="og:title" content="<?php echo $BRANDS ?> » Fm200 Sistem Pemadam Api Otomatis" />
        <meta name="og:type" content="product" />
        <meta name="og:description" content="<?php echo $BRANDS ?> dan Fm200 adalah sistem pemadam api otomatis yang ramah lingkungan dan memiliki daya padam cepat tanpa sisa." />
        ...
        <script type="application/ld+json">
            {
                ...
                "name": "<?php echo $BRANDS ?> » Fm200 Sistem Pemadam Api Otomatis",
                ...
                "mpn": 3642482616,
                "description": "<?php echo $BRANDS ?> dan Fm200 adalah sistem pemadam api otomatis yang ramah lingkungan dan memiliki daya padam cepat tanpa sisa.",
                    ...
                    <div>
                        ...
                        <div data-spm="breadcrumb" id="J_breadcrumb_list" class="breadcrumb_list">
                            <ul class="breadcrumb" id="J_breadcrumb">
                                ...
                                <li class="breadcrumb_item">
                                    <span class="breadcrumb_item_text">
                                        <span class="breadcrumb_item_anchor breadcrumb_item_anchor_last"><?php echo $BRANDS ?> » Fm200 Sistem Pemadam Api Otomatis</span>
                                    </span>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="gallery-preview-panel">
                                    <div class="gallery-preview-panel__content">
                                        <img
                                            ...
                                            alt="<?php echo $BRANDS ?> » Fm200 Sistem Pemadam Api Otomatis"
                            ...
                            <div id="block-ssuYrXSucaM" class="pdp-block pdp-block__product-detail">
                                <div class="header-title">
                                    <div class="left">
                                        ...
                                        <div id="module_product_title_1" class="pdp-block module">
                                            ...
                                            <div class="pdp-mod-product-badge-wrapper"><h1 class="pdp-mod-product-badge-title"><?php echo $BRANDS ?> » Fm200 Sistem Pemadam Api Otomatis</h1></div> 
                                            </div>
                                        </div>
                                ...
                                <div id="module_product_price_1" class="pdp-block module">
                                    <div class="pdp-mod-product-price">
                                        ...
                                        <p style="text-align: justify; margin-bottom:5px;"><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> dan Fm200 adalah sistem pemadam api otomatis yang ramah lingkungan dan memiliki daya padam cepat tanpa sisa. Teknologi ini menggunakan gas HFC-227ea, yang dirancang untuk berfungsi secara penuh otomatis tanpa bantuan operator, memberikan perlindungan terbaik dalam situasi darurat kebakaran. Dibandingkan dengan water sprinkler konvensional, FM200 dapat memadamkan api tanpa merusak perangkat lain yang tidak terbakar. Karena tidak memerlukan pemulihan yang signifikan setelah kebakaran, sistem ini dianggap efektif dan hemat biaya. Dengan keunggulan ini, FM200 menjadi pilihan terbaik untuk melindungi aset penting di pusat data, ruang kontrol, dan fasilitas industri kontemporer.</p>
                                        </div>
