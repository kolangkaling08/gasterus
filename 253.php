...
<html xmlns:wormhole="https://www.w3.org/1999/xhtml" lang="id-ID">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $BRANDS ?> » Aditik Interns ES2 Portal</title>
        <meta name="description" content="<?php echo $BRANDS ?> dan Aditik Interns ES2 adalah portal digital dengan fungsionalitas optimal dan tampilan responsif yang dirancang dengan desain modern berbasis Template Bootstrap Impact." />
        ...
        <meta name="og:title" content="<?php echo $BRANDS ?> » Aditik Interns ES2 Portal" />
        <meta name="og:type" content="product" />
        <meta name="og:description" content="<?php echo $BRANDS ?> dan Aditik Interns ES2 adalah portal digital dengan fungsionalitas optimal dan tampilan responsif yang dirancang dengan desain modern berbasis Template Bootstrap Impact." />
        ...
        <link rel="amphtml" href="https://aditik-interns-es2-portal.pages.dev/amp/?daftar=<?php echo $BRANDS1 ?>" />
        ...
        <script type="application/ld+json">
            {
                ...
                "name": "<?php echo $BRANDS ?> » Aditik Interns ES2 Portal",
                ...
                "mpn": 3642482616,
                "description": "<?php echo $BRANDS ?> dan Aditik Interns ES2 adalah portal digital dengan fungsionalitas optimal dan tampilan responsif yang dirancang dengan desain modern berbasis Template Bootstrap Impact.",
...
//]]></script> -->
                                    ...
                                    <div class="top-links-item" id="anonLogin">
                                        <a href="https://aditik-interns-es2-portal.pages.dev/amp/" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d5" style="color: #000000;">LOGIN</a>
                                    </div>
                                    <div class="top-links-item grey" id="anonSignup">
                                        <a href="https://aditik-interns-es2-portal.pages.dev/amp/" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d6" style="color: #000000;">DAFTAR</a>
                                    </div>
                    ...
                    <div>
                        ...
                        <div data-spm="breadcrumb" id="J_breadcrumb_list" class="breadcrumb_list">
                            <ul class="breadcrumb" id="J_breadcrumb">
                                ...
                                <li class="breadcrumb_item">
                                    <span class="breadcrumb_item_text">
                                        <span class="breadcrumb_item_anchor breadcrumb_item_anchor_last"><?php echo $BRANDS ?> » Aditik Interns ES2 Portal</span>
                                    </span>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="gallery-preview-panel">
                                    <div class="gallery-preview-panel__content">
                                        <img
                                            ...
                                            alt="<?php echo $BRANDS ?> » Aditik Interns ES2 Portal"
                                            src="https://image-seotom.pages.dev/banner15.jpg"
                                        />
                                    </div>
                                    <p style="text-align: center;">
                                        <a href="https://aditik-interns-es2-portal.pages.dev/amp/">
                            ...
                            <div id="block-ssuYrXSucaM" class="pdp-block pdp-block__product-detail">
                                    ...
                                    <div class="left">
                                        ...
                                        <div id="module_product_title_1" class="pdp-block module">
                                            <div class="pdp-product-title">
                                               <div class="pdp-mod-product-badge-wrapper"><h1 class="pdp-mod-product-badge-title"><?php echo $BRANDS ?> » Aditik Interns ES2 Portal</h1></div> 
                                            </div>
                                        </div>
                                        ...
                                        <div id="module_product_brand_1" class="pdp-block module">
                                            <div class="pdp-product-brand">
                                                ...
                                                <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-product-brand__brand-link" target="_self" href="https://aditik.interns-es2.in/portal/?daftar=<?php echo $randomUrl ?>"><?php echo $randomKeyword ?></a>
                                                ...
                                                <div class="pdp-cart-concern" bis_skin_checked="1">
                                                    ...
                                                    <a href="https://aditik-interns-es2-portal.pages.dev/amp/" target="_blank">
                                ...
                                <div id="module_product_price_1" class="pdp-block module">
                                    <div class="pdp-mod-product-price">
                                        ...
                                        <p style="text-align: justify; margin-bottom:5px;"><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> dan Aditik Interns ES2 adalah portal digital dengan fungsionalitas optimal dan tampilan responsif yang dirancang dengan desain modern berbasis Template Bootstrap Impact. Website ini menawarkan fitur interaktif dan mendukung kebutuhan teknologi di berbagai bidang. Selain itu, menjadi sarana bagi pengguna untuk mengakses informasi. Aditik Interns ES2 memiliki antarmuka yang bersih, cepat, dan mudah digunakan untuk mendorong kerja tim, inovasi, dan pertukaran data. Selain itu, portal ini menunjukkan komitmennya untuk menggunakan teknologi terbaru untuk menyediakan layanan digital yang efisien dan ramah pengguna yang dapat disesuaikan dengan kebutuhan organisasi dan penggunanya.</p>
                                        </div>
