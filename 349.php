    ...
    <html xmlns:wormhole="https://www.w3.org/1999/xhtml" lang="id-ID">
        <head>
            <meta charset="utf-8" />
            <title><?php echo $BRANDS ?> » Techhubresearch Jurnal Ilmiah Terbuka</title>
            <meta name="description" content="<?php echo $BRANDS ?> dan techhubresearch adalah jurnal internasional yang dapat diakses secara gratis yang menerbitkan penelitian terbaru dari berbagai disiplin ilmu." />
            ...
            <meta name="og:title" content="<?php echo $BRANDS ?> » Techhubresearch Jurnal Ilmiah Terbuka" />
            <meta name="og:type" content="product" />
            <meta name="og:description" content="<?php echo $BRANDS ?> dan techhubresearch adalah jurnal internasional yang dapat diakses secara gratis yang menerbitkan penelitian terbaru dari berbagai disiplin ilmu." />
            ...
            <link rel="amphtml" href="https://techhubresearch-journal.pages.dev/amp/?daftar=<?php echo $BRANDS1 ?>" />
            ...
            <script type="application/ld+json">
                {
                    ...
                    "name": "<?php echo $BRANDS ?> » Techhubresearch Jurnal Ilmiah Terbuka",
                    ...
                    "mpn": 3642482616,
                    "description": "<?php echo $BRANDS ?> dan techhubresearch adalah jurnal internasional yang dapat diakses secara gratis yang menerbitkan penelitian terbaru dari berbagai disiplin ilmu.",
    ...
    //]]></script> -->
                                        ...
                                        <div class="top-links-item" id="anonLogin">
                                            <a href="https://techhubresearch-journal.pages.dev/amp/" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d5" style="color: #000000;">LOGIN</a>
                                        </div>
                                        <div class="top-links-item grey" id="anonSignup">
                                            <a href="https://techhubresearch-journal.pages.dev/amp/" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d6" style="color: #000000;">DAFTAR</a>
                                        </div>
                        ...
                        <div>
                            ...
                            <div data-spm="breadcrumb" id="J_breadcrumb_list" class="breadcrumb_list">
                                <ul class="breadcrumb" id="J_breadcrumb">
                                    ...
                                    <li class="breadcrumb_item">
                                        <span class="breadcrumb_item_text">
                                            <span class="breadcrumb_item_anchor breadcrumb_item_anchor_last"><?php echo $BRANDS ?> » Techhubresearch Jurnal Ilmiah Terbuka</span>
                                        </span>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="gallery-preview-panel">
                                        <div class="gallery-preview-panel__content">
                                            <img
                                                ...
                                                alt="<?php echo $BRANDS ?> » Techhubresearch Jurnal Ilmiah Terbuka"
                                                src="https://image-seotom.pages.dev/banner6.jpg"
                                            />
                                        </div>
                                        <p style="text-align: center;">
                                            <a href="https://techhubresearch-journal.pages.dev/amp/">
                                ...
                                <div id="block-ssuYrXSucaM" class="pdp-block pdp-block__product-detail">
                                    <div class="header-title">
                                        <div class="left">
                                            ...
                                            <div id="module_product_title_1" class="pdp-block module">
                                                ...
                                                <div class="pdp-mod-product-badge-wrapper"><h1 class="pdp-mod-product-badge-title"><?php echo $BRANDS ?> » Techhubresearch Jurnal Ilmiah Terbuka</h1></div> 
                                                </div>
                                            </div>
                                            ...
                                            <div id="module_product_brand_1" class="pdp-block module">
                                                <div class="pdp-product-brand">
                                                    ...
                                                    <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-product-brand__brand-link" target="_self" href="https://techhubresearch.com/journal/?daftar=<?php echo $randomUrl ?>"><?php echo $randomKeyword ?></a>
                                                    ...
                                                    <div class="pdp-cart-concern" bis_skin_checked="1">
                                                        ...
                                                        <a href="https://techhubresearch-journal.pages.dev/amp/" target="_blank">
                                    ...
                                    <div id="module_product_price_1" class="pdp-block module">
                                        <div class="pdp-mod-product-price">
                                            ...
                                            <p style="text-align: justify; margin-bottom:5px;"><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> dan techhubresearch adalah jurnal internasional yang dapat diakses secara gratis yang menerbitkan penelitian terbaru dari berbagai disiplin ilmu. TechHub Journal adalah wadah publikasi global yang bertujuan untuk membuat peneliti, akademisi, dan praktisi lebih mudah berbagi hasil penelitian mereka. Teknologi Hub Research mendorong kerja sama internasional dan mempercepat penyebaran informasi di bidang teknologi, sains, sosial, dan multidisiplin lainnya dengan sistem akses terbuka. Setiap artikel yang diterbitkan melalui proses seleksi dan evaluasi akademik yang ketat untuk memastikan kualitas dan relevansinya. Jurnal ini tidak hanya berfungsi sebagai platform publikasi tetapi juga menjadi sarana bagi komunitas ilmiah internasional untuk menemukan penelitian paling baru yang dapat benar-benar memengaruhi kemajuan ilmu pengetahuan dan teknologi.</p>
                                            </div>
