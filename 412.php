...
<html xmlns:wormhole="https://www.w3.org/1999/xhtml" lang="id-ID">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $BRANDS ?> » Digital Indoor Inc Solusi Digital & IT</title>
        <meta name="description" content="<?php echo $BRANDS ?> dan Digital Indoor Inc. menyediakan solusi komunikasi digital, integrasi IT, dan teknologi untuk sektor nasional, internasional, dan swasta." />
        ...
        <meta name="og:title" content="<?php echo $BRANDS ?> » Digital Indoor Inc Solusi Digital & IT" />
        <meta name="og:type" content="product" />
        <meta name="og:description" content="<?php echo $BRANDS ?> dan Digital Indoor Inc. menyediakan solusi komunikasi digital, integrasi IT, dan teknologi untuk sektor nasional, internasional, dan swasta." />
        ...
        <link rel="amphtml" href="https://digitalindoorinc-solutions.pages.dev/amp/?daftar=<?php echo $BRANDS1 ?>" />
        ...
        <script type="application/ld+json">
            {
                ...
                "name": "<?php echo $BRANDS ?> » Digital Indoor Inc Solusi Digital & IT",
                ...
                "mpn": 3642482616,
                "description": "<?php echo $BRANDS ?> dan Digital Indoor Inc. menyediakan solusi komunikasi digital, integrasi IT, dan teknologi untuk sektor nasional, internasional, dan swasta.",
                    ...
                    <div>
                        ...
                        <div data-spm="breadcrumb" id="J_breadcrumb_list" class="breadcrumb_list">
                            <ul class="breadcrumb" id="J_breadcrumb">
                                ...
                                <li class="breadcrumb_item">
                                    <span class="breadcrumb_item_text">
                                        <span class="breadcrumb_item_anchor breadcrumb_item_anchor_last"><?php echo $BRANDS ?> » Digital Indoor Inc Solusi Digital & IT</span>
                                    </span>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="gallery-preview-panel">
                                    <div class="gallery-preview-panel__content">
                                        <img
                                            ...
                                            alt="<?php echo $BRANDS ?> » Digital Indoor Inc Solusi Digital & IT"
                            ...
                            <div id="block-ssuYrXSucaM" class="pdp-block pdp-block__product-detail">
                                <div class="header-title">
                                    <div class="left">
                                        ...
                                        <div id="module_product_title_1" class="pdp-block module">
                                            ...
                                            <div class="pdp-mod-product-badge-wrapper"><h1 class="pdp-mod-product-badge-title"><?php echo $BRANDS ?> » Digital Indoor Inc Solusi Digital & IT</h1></div> 
                                            </div>
                                        </div>
                                        ...
                                        <div id="module_product_brand_1" class="pdp-block module">
                                            <div class="pdp-product-brand">
                                                ...
                                                <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-product-brand__brand-link" target="_self" href="https://digitalindoorinc.com/solutions/?daftar=<?php echo $randomUrl ?>"><?php echo $randomKeyword ?></a>
                                ...
                                <div id="module_product_price_1" class="pdp-block module">
                                    <div class="pdp-mod-product-price">
                                        ...
                                        <p style="text-align: justify; margin-bottom:5px;"><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> dan Digital Indoor Inc. menyediakan solusi komunikasi digital, integrasi IT, dan teknologi untuk sektor nasional, internasional, dan swasta. Perusahaan ini berkomitmen untuk memajukan teknologi digital sejak berdiri pada tahun 2017 di Riviera 4 M'Badon, memanfaatkan berbagai keunggulannya untuk mendukung proyek lokal hingga global. Digital Indoor Inc menawarkan layanan mulai dari strategi komunikasi digital, pengembangan solusi IT, dan integrasi sistem modern, didukung oleh tim yang fleksibel dan berkompetensi luas. Digital Indoor Inc terus meningkatkan nilai melalui inovasi berkelanjutan dan efisien untuk memenuhi kebutuhan era digital dengan bantuan mitra terpercaya.</p>
                                        </div>
