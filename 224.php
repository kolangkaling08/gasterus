...
<a href="https://manlumajang-learn.darkhaus.site/amp/" rel="nofollow noreferrer" class="register">LOGIN</a>
  ...
  <div class="pdp-product-brand"><span class="pdp-product-brand__name">MEREK<!-- -->:<!-- --> </span><a target="_self" href="https://jotinastar.com/promo/?daftar=<?php echo $randomUrl2 ?>"><?php echo $randomKeyword2 ?></a></div></div><div id="module_product_attrs" class="pdp-block module"></div><div id="block-cKVxLtoIbl2" class="pdp-block module"></div><div id="module_product_price_1" class="pdp-block module"><div class="pdp-mod-product-price">
